...
```{r, echo=F}
#
load(file='C:/Users/Katerina/Documents/Master thesis/model/weatherIVILAR12_hourly.RData')
weather <- weather_h
weather <- weather[weather$date >= "2022-05-20 16:00:00 UTC", ]

source("C:/Users/Katerina/Documents/Master thesis/model/micro_custom.R")
micro_out <- micro_custom(41.1073, -8.5898, 230, weather, tl, th=F, habitat='soil', slope=0, azmuth=180)

weat_soil <- as.data.frame(micro_out[2])
weat_shadsoil <- as.data.frame(micro_out[4])
weat_humid <- as.data.frame(micro_out[5])
weat_shadhumid <- as.data.frame(micro_out[6])

# soil temperature
tsun1_0cm <- as.data.frame(weat_soil[,c(1,4)])
tsun1_0cm <- data.frame(datetime = round(as.POSIXct(strptime(tsun1_0cm[,1], "%Y-%m-%d %H:%M:%S")),"hours"),
                        temp = tsun1_0cm[,2])
tsun1_10cm <- as.data.frame(weat_soil[,c(1,7)])
tsun1_10cm <- data.frame(datetime = round(as.POSIXct(strptime(tsun1_10cm[,1], "%Y-%m-%d %H:%M:%S")),"hours"),
                         temp = tsun1_10cm[,2])
tsun1_30cm <- as.data.frame(weat_soil[,c(1,10)])
tsun1_30cm <- data.frame(datetime = round(as.POSIXct(strptime(tsun1_30cm[,1], "%Y-%m-%d %H:%M:%S")),"hours"),
                         temp = tsun1_30cm[,2])
tsun1_50cm <- as.data.frame(weat_soil[,c(1,11)])
tsun1_50cm <- data.frame(datetime = round(as.POSIXct(strptime(tsun1_50cm[,1], "%Y-%m-%d %H:%M:%S")),"hours"),
                         temp = tsun1_50cm[,2])

```

```{r, out.width="100%", echo=F}
source("aux_functions.R") # To calculate RMSEs
...
with(tsun1_0cm, points(datetime, temp, type='l', col='red'))
text(as.POSIXct("2022-06-02 00:00:00 UTC"), max(soil$D0cm) * 0.8,
...
text(as.POSIXct("2022-06-02 00:00:00 UTC"), max(soil$D10cm) * 0.8,
...
text(as.POSIXct("2022-06-02 00:00:00 UTC"), max(soil$D30cm) * 0.9, 
...
text(as.POSIXct("2022-06-05 00:00:00 UTC"), max(soil$D50cm) * 0.95, 
...
```{r, out.width="100%", echo=F}
# soil temperature
tshade2_0cm <- as.data.frame(weat_shadsoil[,c(1,4)])
tshade2_0cm <- data.frame(datetime = round(as.POSIXct(strptime(tshade2_0cm[,1], "%Y-%m-%d %H:%M:%S")),"hours"),
                        temp = tshade2_0cm[,2])
tshade2_10cm <- as.data.frame(weat_shadsoil[,c(1,7)])
tshade2_10cm <- data.frame(datetime = round(as.POSIXct(strptime(tshade2_10cm[,1], "%Y-%m-%d %H:%M:%S")),"hours"),
                         temp = tshade2_10cm[,2])
tshade2_30cm <- as.data.frame(weat_shadsoil[,c(1,10)])
tshade2_30cm <- data.frame(datetime = round(as.POSIXct(strptime(tshade2_30cm[,1], "%Y-%m-%d %H:%M:%S")),"hours"),
                         temp = tshade2_30cm[,2])
tshade2_50cm <- as.data.frame(weat_shadsoil[,c(1,11)])
tshade2_50cm <- data.frame(datetime = round(as.POSIXct(strptime(tshade2_50cm[,1], "%Y-%m-%d %H:%M:%S")),"hours"),
                         temp = tshade2_50cm[,2])

# plot
par(mfrow=c(5,1), mar=c(2.5, 4, 0.5, 0.1))

with(shadsoil, plot(micro$dates, D0cm, type='l', xlab='', ylab='Tsoil 0 cm (ºC)'))
...
with(shadsoil, plot(micro$dates, D0cm, type='l', 
                    ...
                    xlab='', ylab='Tsoil 0 cm (ºC)'))
with(tshade2_0cm, points(datetime, temp, type='l', col='red'))
text(as.POSIXct("2022-06-01 00:00:00 UTC"), max(shadsoil$D0cm) * 0.9, 
...
text(as.POSIXct("2022-06-01 00:00:00 UTC"), max(shadsoil$D10cm) * 0.9, 
...
text(as.POSIXct("2022-06-01 00:00:00 UTC"), max(shadsoil$D30cm) * 0.95, 
...
text(as.POSIXct("2022-06-01 00:00:00 UTC"), max(shadsoil$D50cm) * 0.9, 
...
```{r, out.width="100%", echo=F}
# soil humidity
hsun1_0cm <- as.data.frame(weat_humid[,c(1,4)])
hsun1_0cm <- data.frame(datetime = round(as.POSIXct(strptime(hsun1_0cm[,1], "%Y-%m-%d %H:%M:%S")),"hours"),
                        hum = hsun1_0cm[,2])
hsun1_30cm <- as.data.frame(weat_humid[,c(1,10)])
hsun1_30cm <- data.frame(datetime = round(as.POSIXct(strptime(hsun1_30cm[,1], "%Y-%m-%d %H:%M:%S")),"hours"),
                         hum = hsun1_30cm[,2])
hsun1_50cm <- as.data.frame(weat_humid[,c(1,11)])
hsun1_50cm <- data.frame(datetime = round(as.POSIXct(strptime(hsun1_50cm[,1], "%Y-%m-%d %H:%M:%S")),"hours"),
                         hum = hsun1_50cm[,2])
...
with(humid, plot(micro$dates, RH0cm * 100, type='l', ylim=c(0,100), 
                 ...
                 xlab='', ylab='RH 0 cm (%)'))
with(hsun1_0cm, points(datetime, hum * 100, type='l', col='red'))
text(as.POSIXct("2022-05-24 00:00:00 UTC"), 15, 
...
```{r, out.width="100%", echo=F}
# soil humidity
hshade1_10cm <- as.data.frame(weat_shadhumid[,c(1,4)])
hshade1_10cm <- data.frame(datetime = round(as.POSIXct(strptime(hshade1_10cm[,1], "%Y-%m-%d %H:%M:%S")),"hours"),
                           hum = hshade1_10cm[,2])
hshade1_30cm <- as.data.frame(weat_shadhumid[,c(1,10)])
hshade1_30cm <- data.frame(datetime = round(as.POSIXct(strptime(hshade1_30cm[,1], "%Y-%m-%d %H:%M:%S")),"hours"),
                           hum = hshade1_30cm[,2])
hshade1_50cm <-as.data.frame(weat_shadhumid[,c(1,11)])
hshade1_50cm <- data.frame(datetime = round(as.POSIXct(strptime(hshade1_50cm[,1], "%Y-%m-%d %H:%M:%S")),"hours"),
                           hum = hshade1_50cm[,2])
...
with(shadhumid, plot(micro$dates, RH10cm * 100, type='l', ylim=c(0,100), 
                     ...
                     xlab='', ylab='RH 10 cm (%)'))
with(hshade1_10cm, points(datetime, hum * 100, type='l', col='red'))
text(as.POSIXct("2022-05-30 00:00:00 UTC"), 15, 
